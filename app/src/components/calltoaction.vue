<template>
  <div class="py-10">
    <section class="bg-white opacity-100">
      <div
      ...
      >
        <div
          class="absolute top-1 left-4 sm:top-2 sm:left-8 lg:top-5 lg:left-16"
        >
          <h1
        ...
        >
          ...
          <p class="text-md md:text-2xl lg:text-4xl font-bold text-white">it</p>
          <p class="text-md md:text-2xl lg:text-4xl text-white font-bold">
            Home!"
          </p>
        </div>
