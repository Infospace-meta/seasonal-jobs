<template>
    <div>
<p>Seasonal Jobs values the privacy of our users. Therefore, this privacy policy explains in detail how we  use and protect the information we collect when you visit our website, as well as our social platforms. Read this privacy policy completely. Please refrain from visiting the site if the terms outlined below are not satisfactory to you.
...
Therefore, we advise our customers to frequently review our privacy policy so that they remain aware of its updates. By using the site, you accept that the posted policy and all its changes apply to your interaction with Seasonal Jobs.
</p>
<h2>Information Collected by Seasonal Jobs</h2>
<p>Personal information may be collected by this site in many ways. This information includes:</p> 
<li>	Personal identifying information like your name, address, email, phone number, age, gender, and other personal data</li>
<li>	Server data related to the IP address you used to visit our Seasonal Jobs Website, which includes your address, browser, OS, access time, and site activity.</li>
<li>	Financial information related to your orders including your payment method and identifying payment information. We rarely store financial information collected on our site for transaction purposes. That information gets sent directly to our payment processor, Intasend.</li>
<li>	Social network data including Facebook permissions and user information from other networks, provided you log onto our site using one of these media sites.</li>
...
<p> Our Seasonal Jobs Website uses information collected to:</p>
...
<li>With our third-party providers for payment processing and hosting</li>
...
<li>If this site goes bankrupt and data must be transferred</li>
	...
	<h2>Cookies, Trackers, and Online Ads</h2>
	



<p> We may use cookies, trackers, web beacons, and other technology to customize our Seasonal Jobs Website to improve your experience. We may customize the site using this information. These trackers do not have access to your personal information and can be removed from your browser options.
In addition, third-party software provides ads for our site for marketing campaigns. These programs have access to tracking technology to optimize your ad experience. For more information about these ads, visit advert.idonotknow.com
...
Kenya’s Privacy Rights
Enumerate your state’s privacy codes and any permits, legal age limits, or associated information necessary for people in your specific jurisdiction.
Contact Us
If you have questions or concerns about this privacy policy, please feel free to contact us at: Seasonal Jobs, 128 City Road, London, +254 796309986, info@seasonaljobsuk.com.
