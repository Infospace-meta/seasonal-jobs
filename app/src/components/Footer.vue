<template>
  <section class="bg-gray-50">
    <div class="md:max-w-xl lg:max-w-7xl mx-auto py-5 text-gray-500">
      ...
      >
        <!-- seasonaljobs logo -->
        <div class="grid grid-cols-1 justify-content-center place-content-center space-y-5">
          ...
          <div class="grid justify-items-center place-items-center space-y-5">
            <p class="leading-relaxed text-gray-500">Remember next may be too late!<br>
              You have to be it to win it
            </p>
            <button class="bg-orange-400 px-7 py-1"><router-link to="/register"></router-link>Register</button>
          </div>
      ...
      <!-- bottom part -->
      <div
        class="grid grid-cols-1 justify-center items-center md:grid md:grid-cols-1 md:justify-between md:items-center lg:grid lg:grid-cols-1 lg:justify-between lg:items-center mx-5 py-5 space-y-3"
      >
        <!-- bottom_right part -->
        <div
          class="grid grid-cols-1 justify-center items-center text-gray-500 space-y-2"
        >
          <div
