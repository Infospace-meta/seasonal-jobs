<template>
  <section class="bg-gray-50">
    <div class="md:max-w-xl lg:max-w-7xl mx-auto py-5 text-gray-500">
      <div
        class="grid grid-cols-1 justify-content-start place-items-start lg:grid lg:grid-cols-2 justify-content-start lg:place-items-start py-10"
      >
        <router-link to="/">
          <div class="h-3/4 w-3/4 ml-4">
            <img
        ...
        <div>
          <div
            class="grid grid-cols-1 justify-content-start place-items-start lg:grid lg:grid-cols-2 lg:justify-content-start lg:place-items-start py-3"
          >
            <div
