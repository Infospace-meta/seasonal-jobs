  ...
  <section class="bg-gray-50">
    <div class="max-w-7xl mx-auto py-5">
      ...
      <div class="grid grid-cols-1 justify-center items-center space-y-10 py-10 md:grid md:grid-cols-3 md:justify-between sm:items-center sm:py-14 mx-5">
        ...
        <div>
          <ul class="flex justify-center items-center gap-5">
            <li class="text-gray-500 hover:text-green-950 hover:pb-2" ><router-link to="">Home</router-link></li>
            <li class="text-gray-500 hover:text-green-950 hover:pb-2"><router-link to="">About</router-link></li>
            <li class="text-gray-500 hover:text-green-950 hover:pb-2"><router-link to="">Contact</router-link></li>
            <li class="text-gray-500 hover:text-green-950 hover:pb-2"><router-link to="">Register</router-link></li>
          </ul>
        </div>
        <!-- social icons -->
      ...
      <div class="grid grid-cols-1 justify-center items-center md:grid md:grid-cols-2 md:justify-between md:items-center mx-5 py-5">
        ...
        <!-- bottom_right part -->
        <div class="flex justify-end items-end gap-2 text-gray-500 tracking-tight lg:tracking-normal ">
          <div>
            <svg
            xmlns="http://www.w3.org/2000/svg"
            width=""
            height=""
            fill="currentColor"
            class="bi bi-c-circle h-3 w-3 mb-1"
            viewBox="0 0 16 16"
          >
            <path
