<template>
  <section class="bg-gray-50">
    <div class="max-w-7xl mx-auto py-5">
      ...
      <div
        class="grid grid-cols-1 justify-center items-center space-y-10 py-10 md:grid md:grid-cols-3 md:justify-between sm:items-center sm:py-14 mx-5"
      >
        <!-- seasonaljobs logo -->
      ...
      >
        ...
        >
          <div class="flex justify-center items-center lg:flex lg:justify-end lg:items-end space-x-1">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width=""
              height=""
          ...
          <p class="flex justify-center items-center lg:flex lg:justify-end lg:items-end">Created by Info-space meta</p>
        </div>
      </div>
    </div>
  </section>
