<template>
  <div>
    <section class="relative py-16 overflow-hidden sm:py-20 lg:py-24 xl:py-56">
  <!-- Background Image -->
  ...
  <!-- Background Overlay -->
  <div
    class="absolute inset-0 hidden bg-gradient-to-r md:block from-green-800 to-transparent bg-opacity-60"
  ></div>
