<template>
  <div>
    <section class="relative py-16 overflow-hidden sm:py-20 lg:py-24 xl:py-56 h-[800px]">
  <!-- Background Image -->
  ...
  <!-- Background Overlay -->
  <div
    class="absolute inset-0 hidden bg-gradient-to-r md:block from-white to-transparent bg-opacity-60"
  ></div>
  ...
  <div class="relative px-4 mx-auto sm:px-6 lg:px-6 max-w-6xl">
    <div class="text-center md:w-2/3 lg:w-1/2 xl:w-1/2 md:text-left">
      <h2
        class="text-3xl font-semibold text-white lg:text-black sm:text-4xl lg:text-5xl md:text-black"
      >
       Earn between £500 & £800 / week
      </h2>
      <p class="mt-4 text-2xl text-white lg:text-gray-900 md:text-black">
